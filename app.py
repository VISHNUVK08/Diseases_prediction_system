...
breast_model = pickle.load(open(f'{working_dir}/saved_models/breast_model.sav', 'rb'))
...
with st.sidebar:
    selected = option_menu('Disease Prediction System',
                           ...
                           menu_icon='hospital',
                           icons=['activity', 'heart-pulse', 'person','capsule-pill'],
                           default_index=0)
...
if selected == 'Breast Cancer Prediction':
    ...
    if st.button('Breast Cancer Test Result'):
        ...
        breast_prediction = breast_model.predict([user_input])
